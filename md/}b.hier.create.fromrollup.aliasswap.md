...
|Process|ExecuteProcess|RunProcess|
  ...
  |[`}bedrock.dim.attr.create`](}bedrock.dim.attr.create)|Y|N|
  |[`}bedrock.cube.data.copy`](}bedrock.cube.data.copy)|Y|N|
  |[`}bedrock.dim.attr.swapalias`](}bedrock.dim.attr.swapalias)|Y|N|
  |[`}bedrock.dim.attr.delete`](}bedrock.dim.attr.delete)|Y|N|
  |[`}bedrock.dim.delete`](}bedrock.dim.delete)|Y|N|
