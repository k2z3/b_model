601,100
602,"}b.hier.consol.delete"
562,"NULL"
586,
585,
564,
565,"siR<>56M[0:qTE\UXKLa5KaiRCIpK`=F>o>JtC\Qcp@AE[ctNs::l<6mjB\5:0840T4S]wC5b0mtHAO4fT;I4\GXwTwYk_CJgfb0iunpwZ@<8QmiaWfoWKV]tYK;py@<F2z6iCBkRcV>0tYokX9XDN1JM`0JhNZyN>EEIy0nOi22zYYSHg?=c^Zxn[<@:crGP]_4IC42"
559,1
928,0
593,
594,
...
If( 1 = 0 );
    ExecuteProcess( '}b.hier.consol.delete', 'pLogOutput', pLogOutput,
...
While( nDelimiterIndex <> 0 );
    ...
    Else;
        ...
        sEle    = '"'|sEle|'"';
        sProc   = '}b.hier.sub.create.bymdx';
        sMdx    = '{TM1FILTERBYPATTERN( {TM1SUBSETALL([ ' |pDim|':'|sHier |' ])},'| sEle| ')}';
        ExecuteProcess('}b.hier.sub.create.bymdx',
