601,100
602,"}b.cube.viewandsubsets.delete"
562,"NULL"
586,
585,
564,
565,"xlDMndlURwJtNR`_C][^yUEFa:;2MS8QTL4\Lj4U`ExOL:p\miAA[>5CZyqt:TTNJ7X;5cUIJF4tKv92ZJ@9:4]DA?X7wX?\r<`?DW@EYBpNVY;JkOKCp@E4S4PoMK;<sCIMm:]YMPLLgne1?YKu<Xh=oQVY[_TIHSjfGId3AyaNSOFJEYpslAwz>CGg[ACE\tMdrgAS"
559,1
928,0
593,
594,
...
If( 1 = 0 );
    ExecuteProcess( '}b.cube.viewandsubsets.delete', 'pLogOutput', pLogOutput,
...
If( pMode       <= 1 );
    ...
    While( sDimName @<> '' );
        If( SubsetExists ( sDimName, cSubset ) = 1 );
            If( pMode = 0 );
                # "indirect" deletion
                 nRet = ExecuteProcess( '}b.hier.sub.delete',
                  'pStrictErrorHandling', pStrictErrorHandling,
