...
585,"}Cubes"
564,
565,"nP6;cJQT5oDL1_aFxIMjV8wh>GQWy?ISXK@oaKc\w:;tLw5QxIoS9YwZ>^ugKupK=BxZQ>vU\;b\WQtkY]P:ezftNL>5[y_DrR>kbK?5<fzlM=NIauw;Oh>G:Bf3HzY__5ooxBPb4@iBIOG_9WOiLT8zRe:iBg]h;M28dtd9ZNv7Sf6ut]CS2b7LSc4B<UCyys[ej2rx"
559,1
928,0
593,
594,
...
pTgtDim,"OPTIONAL: Target Dimension (will default to pSrcDim{repl If blank (or) is same as pSrcDim)"
...
If( 1 = 0 );
    ExecuteProcess( '}b.dim.clone', 'pLogOutput', pLogOutput,
...
Else;
    IF(pUnwind = 1 );
       nRet = ExecuteProcess('}b.hier.unwind',
    ...
    While( nCtr <= nMax );
        ...
        If(nElestart > 1);
         ...
         If ( vSourceHierarchy @<> 'Leaves');
             nRet = EXECUTEPROCESS('}b.hier.clone',
               'pLogOutput', pLogOutput,
               'pStrictErrorHandling', pStrictErrorHandling,
               'pSrcDim', sDim,
