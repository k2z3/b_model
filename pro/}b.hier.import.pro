...
585,"C:\TM1Models\Slavneft_TEST\dim01 dim01_Export.csv"
564,
565,"fkdMEwyO5Av]SP3QBTvxre;8?Tu@GB=F:xxRQ4uo0YW5Lxw<;qlms:?ud:S11WeAn7zd7IHuFun?fJ_pDHnDz4F;WVbkcX`vd[G1MHdl^lnYc3qB~No9e?[c65rGPEprMpZady<>YimCN=w703T5M6gRf9G]a6kEY3iU=TTZ7Ia)OFckxagKkXrfw[Q^GDb\f\dswqm"
559,1
928,0
593,
594,
...
If( 1 = 0 );
ExecuteProcess( '}b.hier.import', 'pLogOutput', pLogOutput
...
# is able to read a file generated by `}b.hier.export`.
