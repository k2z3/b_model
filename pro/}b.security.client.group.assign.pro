601,100
602,"}b.security.client.group.assign"
562,"NULL"
586,
585,
564,
565,"l1LZalJvzTx^ad?m7CP^MiHoXFNyJZ2d>m;c4beT3wT<vOc];52X\RC[gelFRw:BQDK:riowvH`B6dAD;B?id0]m0vw_GPD@s8Rke\]YFN1h@3D?akGcSRxEryV^GiuoPBK<mWIRQn21C1]hSBQ5:\INSjSYBlwwpk?;TjlSkheRTsC`S:ngIEUB5WO<EWXbLUHO?rye"
559,1
928,0
593,
594,
...
If( 1 = 0 );
    ExecuteProcess( '}b.security.client.group.assign', 'pLogOutput', pLogOutput,
...
# 1/ After adding new user(s) using '}b.security.client.create' they must be assigned to groups.
