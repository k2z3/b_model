601,100
602,"}b.hier.create.fromsubset"
562,"SUBSET"
586,"}Cubes"
585,"}Cubes"
564,
565,"ayUJbzhFF[cfAEetP6udOs90K8K0t5wzfS@A4Vo]jd_bFMhi\c<WH>fbgQYaZLgF?`iq5:iH_:vd<ZAkS<4>HV2uK@Fi;tgQSrj3==<R=kW80lJ\f?9y;nN2C69ffV26BTSN;ZG;ZMI(?3FYxQ15]jkBx?\E\w2300c5tM_UUFFbeTW>W]NlF;bMm\hmsnn\Weq1sY7R"
559,1
928,0
593,
594,
...
If( 1 = 0 );
    ExecuteProcess( '}b.hier.create.fromsubset', 'pLogOutput', pLogOutput,
...
Else;
    IF(pUnwind = 1 );
        ExecuteProcess( '}b.hier.unwind', 'pLogOutput', 0,
            'pStrictErrorHandling', pStrictErrorHandling,
