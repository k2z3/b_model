601,100
602,"}b.hier.sub.create.bylevel"
562,"NULL"
586,
585,
564,
565,"xEQt5>b5Xg>KH95lPkPP>s>Ka]3`jij=X7tvEjR7np89zlK0;9wHB1S[^DPtHc5tNcHrrm9hbTKjr@@CM3Zi<EW0O5`@9^ySX2Y<gY@@iuH=6T@q`1SM`:=GVrDROGgNmw7XldxwD088_dqmOICriR;Gm?z>k^khu4k8SVYSPyMY`:M7oywV1Eiyu>vzxwHMp0_NL2WL"
559,1
928,0
593,
594,
...
If( 1 = 0 );
    ExecuteProcess( '}b.hier.sub.create.bylevel', 'pLogOutput', pLogOutput,
