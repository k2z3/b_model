601,100
602,"}b.server.encrypt.file"
562,"NULL"
586,
585,
564,
565,"rQyZ?6JWt^Z6_6s=5\aF`ux[?;RQpDfTcH7gad4ZFlOv6FNjN;fAz3oe5>nrLZd1JEGDFnhhx[Nc7iTky=]:_C6QTsE2KAM>_P[=?C6djl`a_sgMKkGnLfDJ_3l2okl68c=A`U];_4XDHgytuo7_AiI2s3yzDnFZ<1Zl8JfnMAUUWWhfi6gSE<BW`mRdtOm8Pw4BBTH<"
559,1
928,0
593,
594,
...
If( 1 = 0 );
    ExecuteProcess('}b.server.encrypt.directory', 'pLogOutput', pLogOutput,
