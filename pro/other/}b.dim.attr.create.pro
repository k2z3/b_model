601,100
602,"}b.dim.attr.create"
562,"NULL"
586,
585,
564,
565,"nWGQCPHdfmhvmda30JuLGnI`K;A9QuY`MSZ6rDcICTKBuehRF2\d\S8]`roFwY6@A5cT<io]VI0qca[?0dU?BWP1V55iTQe9TVnNHn[hf3V8=yFAd`D[PM<GveWhk`Yus<;QAx`qnw_]@teMke4B`ltPJ`OGtVwC5t4BuVF1u:LJVh_Rjlcs5i;pwX@[>=?haT`eVoso"
559,1
928,0
593,
594,
...
If( 1 = 0 );
    ExecuteProcess( '}b.dim.attr.create', 'pLogOutput', pLogOutput,
