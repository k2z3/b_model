601,100
602,"}b.server.encrypt.directory"
562,"NULL"
586,
585,
564,
565,"y4AcIAB^^fWRMqWYZM3rydcIcaj99cX5QLp4YDh^DG9_OaxcxdKfVQmq6uv]qgR?vBAP400>PtleuHOeCCIaxYGdXdMOH3TwY3Gstpw?uMzd9>yJ1fLL8UZ5S:=gDTR\ll6znf045\buznRg929u8Wt:mJ6z3l438x0j@bj]cQ?3YXguLs6tC;U9aw2uNdav0=;AF9=f"
559,1
928,0
593,
594,
...
While ( sFile @<> '' );
  ...
  ENDIF;
  nRet = ExecuteProcess('}b.server.encrypt.file',
