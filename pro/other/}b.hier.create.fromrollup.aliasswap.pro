601,100
602,"}b.hier.create.fromrollup.aliasswap"
562,"NULL"
586,
585,
564,
565,"fE4AV?aKMSw;orAmApSBRXDV=6?uI1NYp4Jfi`ew;vd2SacPn_ryrEGsX@bJBAW2ph<p@hu\h]UD7vzmLpzE4YQV3k6eP:IAp:04_5Q\zZ2>LrPaHhQOMZrZSAt^:3VK=Nl3Q4sVXJ\ztFR;pqWdKowy^HxkruFS1<aB?iY9mg\mB[myliOafamC\HtKt`LJdd>lCbYQ"
559,1
928,0
593,
594,
...
#create subset
ExecuteProcess('}b.hier.sub.create',
...
ExecuteProcess('}b.hier.create.fromsubset',
  'pLogOutput',pLogOutput,
  'pStrictErrorHandling', pStrictErrorHandling,
  'pSrcDim',pSrcDim,
  'pSrcHier', pSrcHier,
...
ExecuteProcess('}b.dim.attr.create',
  'pLogOutput',pLogOutput,
  'pStrictErrorHandling', pStrictErrorHandling,
  'pDim',cTempDim,
  'pAttr', cTempDim,
...
ExecuteProcess('}b.cube.data.copy',
  'pLogOutput',pLogOutput,
  'pStrictErrorHandling', pStrictErrorHandling,
...
ExecuteProcess('}b.dim.attr.swapalias',
  'pLogOutput',pLogOutput,
  'pStrictErrorHandling', pStrictErrorHandling,
  'pDim',cTempDim,
  'pAlias', cTempDim
...
ExecuteProcess('}b.dim.attr.delete',
  'pLogOutput',pLogOutput,
  'pStrictErrorHandling', pStrictErrorHandling,
  'pDim', pTgtDim,
  'pAttr', cTempDim
...
IF(pRemove = 1);
  ...
  ExecuteProcess('}b.hier.emptyconsols.delete',
  'pLogOutput',pLogOutput,
  'pStrictErrorHandling', pStrictErrorHandling,
	'pDim',pSrcDim,
	'pHier', pSrcHier
