601,100
602,"}b.hier.sub.create.attribute.leaf"
562,"NULL"
586,
585,
564,
565,"n4fLYx5?03nZG0aT^ZIQst4\6Tydi;UcDN7XQhuANwlJn7x2ym6HHOTbxzXAH8S7dNKc[y0c2ddLGpfR2uVtI9<XFb0X?4xz^dNykWk51:@;?je9k^F?u[Ao>dxsI4ydr]KMg[RUT^26w>6LDo2rw`XpVh=BYanmK\69Ibw^Rgocqdu<^SajP>23[LBVHvpM8OrqN^md"
559,1
928,0
593,
594,
...
If( 1 = 0 );
    ExecuteProcess( '}b.hier.sub.create.attribute.leaf', 'pLogOutput', pLogOutput,
...
nRet = ExecuteProcess('}b.hier.sub.create',
                              'pStrictErrorHandling', pStrictErrorHandling,
                              'pDim', pDim,
                              'pHier', pHier,
                              'pSub', pSub,
