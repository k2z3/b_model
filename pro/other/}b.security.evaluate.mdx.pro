601,100
602,"}b.security.evaluate.mdx"
562,"NULL"
586,
585,
564,
565,"aaP^6?6YrMSf0eNG=FJb9684XfiQ0Q4bR?q2bgSij7rjkm7w^[4@oh:zawCUMEgPv[eaFlKXa3\XS:wD]qDQVh1J@FNl4Q9JPk0<XzqlZ1R8dFAkfHYn]EC=fG2=`>LqKjyR;I3WxqX]@gE8MIVC1gklGtFoDypQ`;OpVyKS<=UOw>4Rq3tpBqr\KRQe6ACLMRK76lfs"
559,1
928,0
593,
594,
    ...
    ########################################      
        ...
        While ( iUser <= nMaxUser );
            ...
            While ( sSubset @<> '' );
                ...
                If ( sSubset @<> '' );
                    nRet = ExecuteProcess('}b.security.evaluate.mdx.private',
