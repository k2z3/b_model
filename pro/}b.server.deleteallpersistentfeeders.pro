601,100
602,"}b.server.deleteallpersistentfeeders"
562,"NULL"
586,
585,
564,
565,"pqr4c3bWc<oXILeAy]yr8pwgvOSR:<>s0tOxk\sEryrtHDjEdQiP3>I^kdT1zF4RGgltZJub@TkAsxUbnJSqa5u3YYI\H2\VegT2M@@6ljU@@UDsqt=8xtM2@gydG?3aLlR>0jbb_b\pRWihFHz4=zAN3Z:n5tyVAFdunl2aIRUG`YaFXaRp^IKujQVRAf1fEzBpF]>"
559,1
928,0
593,
594,
...
If( 1 = 0 );
    ExecuteProcess( '}b.server.deleteallpersistentfeeders', 'pLogOutput', pLogOutput,
