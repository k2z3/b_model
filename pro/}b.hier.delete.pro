...
585,
564,
565,"okDmDPLcxPPtRJCa\`n4@vWman[Y;^qSJzvot2UX50wI5oG2EngqWOyINY[4yAXODdpuh>Rd=Z47GYIuSQ4=<LILllamtUKvbz>u3tUs41<3@GpwDe;<ax6Ti688GU6D0hz[ycUu1l^Yi[dtEBCMX8cW6aceFRxxhvCaUlG_q1eV\J;cw<XhzRue16DDSp@9IlJqX9Yf"
559,1
928,0
593,
594,
...
If( 1 = 0 );
    ExecuteProcess( '}b.hier.delete', 'pLogOutput', pLogOutput,
...
ElseIf(  Scan( '*', pHier ) = 0 & Scan( '?', pHier ) = 0 & Scan( pDelim, pHier ) = 0 & Scan( '*', pDim ) = 0 & Scan( '?', pDim ) = 0 & Scan( pDelim, pDim ) = 0 & Trim( pHier ) @= Trim( pDim ) );
  nErrors = 1;
  sMessage = 'Cannot delete same named hierarchy: "}b.dim.delete" process should be used for this purpose';
  LogOutput( cMsgErrorLevel, Expand( cMsgErrorContent ) );
EndIf;
