601,100
602,"}b.cube.dimension.delete"
562,"NULL"
586,
585,
564,
565,"y9SYn4M=;3]tfSN6;@9?lf3Fka=hJnh4AgFy;wkfNyN2XyC=>>T7In`rJnoj`]amm<m\7lgKRuEbZF_E7?f>Ny;bKydNepZdD2RIAwLp@DK6I\l28bH[1JSRJmRqtg27Ww^QrEZ@fu^f\3pjQmosC8c84jCOqLhwGd7P4d<Xn2iDMPI7L0JRFS2tY6beYC3^Y;S9GylW"
559,1
928,0
593,
594,
...
# copy back the data
IF(pIncludeData = 1);
    sProc = '}b.cube.data.copy.intercube';
    nRet = ExecuteProcess( sProc,
        'pLogOutput', pLogOutput,
        'pStrictErrorHandling', pStrictErrorHandling,
        'pSrcCube', pCloneCube,
